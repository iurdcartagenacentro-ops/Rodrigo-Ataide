...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex overflow-x-hidden">
      ...
      {/* Main Content Area */}
      <main className={`flex-grow transition-all duration-300 lg:ml-64 min-h-screen flex flex-col w-full`}>
          ...
          {currentView === 'config' && (
            <div className="p-8 flex items-center justify-center h-full min-h-[60vh]">
               <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-400 font-medium">Ajustes de base de datos y personalización.</p>
               </div>
            </div>
          )}
        </div>
